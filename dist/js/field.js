...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_viewerjs_dist_viewer_css__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_v_viewer__ = __webpack_require__(8);
...
Nova.booting(function (Vue, router) {
    Vue.use(__WEBPACK_IMPORTED_MODULE_1_v_viewer___default.a);
    Vue.component('index-array-images', __webpack_require__(10));
    Vue.component('detail-array-images', __webpack_require__(13));
    Vue.component('form-array-images', __webpack_require__(16));
});
...
var render = function() {
  ...
  return _c(
    "span",
    {
      ...
      staticClass: "flex flex-row overflow-x-auto scrolling-touch p-2",
      staticStyle: { width: "15rem", height: "10rem" }
    },
    _vm._l(JSON.parse(_vm.field.value), function(img, index) {
      return _c("img", {
        key: index,
        staticClass: "rounded h-10 mr-2 border border-primary",
      ...
      _c("template", { slot: "field" }, [
        ...
        _c(
          ...
          _vm._l(_vm.images, function(img, index) {
            return _c("div", { key: index, staticClass: "w-1/2 p-2 mb-4" }, [
              _c("p", [
                _c("img", {
                  staticClass: "rounded",
                  attrs: { src: img.url, alt: img.name }
              ...
              _c(
                ...
                {
                  staticClass:
                    "text-danger hover:font-bold no-underline mb-2 mt-2",
                  attrs: { href: "#" },
                  on: {
